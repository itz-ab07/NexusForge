export function GridBackdrop() {
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 h-[500px] w-[500px] rounded-full bg-[oklch(0.68_0.25_300/0.2)] blur-3xl animate-float" style={{ animationDelay: "2s" }} />
    ...
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      {items.map((_, i) => {
        ...
        return (
          <span
            key={i}
            className="absolute rounded-full bg-[oklch(0.85_0.18_200)] opacity-70 animate-float"
            style={{
              left: `${left}%`,
              top: `${top}%`,
              width: size,
