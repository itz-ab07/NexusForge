        ...
        <div className="grid gap-10 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 max-w-sm text-sm text-muted-foreground">
              The collaborative coding platform for elite competitive programmers and engineering
              teams.
            </p>
            <div className="mt-5 flex gap-3">
              {[Github, Twitter, MessageSquare].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="grid h-9 w-9 place-items-center rounded-lg glass hover:glow-cyan transition"
                >
